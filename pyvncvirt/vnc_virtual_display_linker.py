...
#      CONFIGURATION
# =======================
PC_MONITOR_WIDTH = 3844
PC_MONITOR_LENGTH = 1440
VIRTUAL_MONITOR_WIDTH = 1680
VIRTUAL_MONITOR_LENGTH = 1050
...
class ScreenManager:
    ...
    def new_monitor(self):
        ...
        os.system("xrandr --addmode DisplayPort-0 " + conf[orientation].xrandr_mode.alias)
        os.system("xrandr --output DisplayPort-0 --mode " + conf[orientation].xrandr_mode.alias)
        os.system('xrandr')
    ...
    def delete_monitor(self):
        ...
        os.system("xrandr --output DisplayPort-0 --off")
        os.system("xrandr --delmode DisplayPort-0 " + conf[orientation].xrandr_mode.alias)
        os.system('xrandr')
        self.conf[self.get_orientation].is_monitor_created = False
